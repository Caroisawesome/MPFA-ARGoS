...
void MPFA_loop_functions::PostExperiment() {
    ...
    if (PrintFinalScore == 1) {
        ...
        string header = "./results/"+type+"_static_MPFA_n"+num_nests.str()+"_r"+num_robots.str()+"_tag"+num_tag.str()+"_"+arena_width.str()+"by"+arena_width.str()+"_delivery_" + delivery.str()+"_vary_speed_"+ varySpeed.str()+"_quard_arena_" + quardArena.str() +"_";
